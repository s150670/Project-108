function startClassification() {
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/prZVAZu2Y/model.json', modelReady);
  }
  ...
  function gotResults(error, results) {
    if (error) {
      ...
      img1 = document.getElementById('noise2');
      img2 = document.getElementById('noise3');
      img3 = document.getElementById('noise4');
